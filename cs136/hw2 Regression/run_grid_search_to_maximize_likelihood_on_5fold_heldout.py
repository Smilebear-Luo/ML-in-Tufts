...
if __name__ == '__main__':
    ...
    for N, line_color in [ (16, 'g'), (512, 'b')]:
        ...
        for order in order_list:
            ...
            best_estimator = kfold_grid_searcher.best_estimator_ ## TODO replace this line! ask kfold_grid_searcher for best estimator
            best_score = kfold_grid_searcher.best_score_ ## TODO replace this line! ask kfold_grid_searcher for best score averaged across folds
